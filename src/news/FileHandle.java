 ...
 *
 * @author Sanatt Abrol
 * This is a class made to handle files and folders for efficient Crap-WH working
 * This is a free to use class 
 * Any one can freely view, copy the source code from this class
 * Visit www.github.com/mavrk/bitm-cyberoam-client
 * This repository is open and contains the source code for Crap-WH
 * The source code for Crap-WH is free and can be used without permission for non-commercial and personal use	
 */
